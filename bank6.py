...
# def Transaction_mony(account_num):
#      account_num = input("Enter deposit account number :")
#      #account_num1 = input("Enter withrow account number :")
#      amount=check_amount()
#      #balance=int(check_balance(account_num))
#      if True:
    ...
    while True:     
        ...
        if "E" == check_C_E:
            ...
            if choice==1:                    #print("1. create employee ") 
                ...
                try: 
                    account_num=(input("enter chenge  Account number or employee number : ") )
